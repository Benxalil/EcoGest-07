      ...
      <Layout>
        <div className="container mx-auto p-6">
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-2">Aucune classe trouvée</h3>
              ...
              <div className="py-4">
                {classExamens.length === 0 ? (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-500 dark:text-gray-400 text-lg mb-2">Aucun examen créé pour cette classe</p>
