...
export default function NotesParEleve() {
  ...
  const filteredEleves = eleves.filter(eleve => {
    ...
    const matchesClasse = selectedClasseFilter === "all" || 
      eleve.classe === selectedClasseFilter ||
      resolveClasseId(eleve.classe) === selectedClasseFilter;
          ...
          <div className="lg:col-span-1">
            <Card>
              ...
              <CardContent className="space-y-4">
                {/* Filtre par classe */}
                <div>
                  <Select value={selectedClasseFilter} onValueChange={setSelectedClasseFilter}>
                    <SelectTrigger>
                ...
                <CardHeader>
                  ...
                  <div className="flex items-center gap-4">
                    <Select value={selectedSemestre} onValueChange={setSelectedSemestre}>
                      ...
                      <SelectContent>
                        <SelectItem value="semestre1">
                          {isTrimestreSystem ? "1er Trimestre" : "1er Semestre"}
                        </SelectItem>
                        <SelectItem value="semestre2">
                          {isTrimestreSystem ? "2ème Trimestre" : "2ème Semestre"}
                        </SelectItem>
                      </SelectContent>
                    </Select>
                    {semesterAverage > 0 && (
                      <div className="text-sm text-muted-foreground">
                        Moyenne: <span className="font-semibold">{semesterAverage.toFixed(2)}/20</span>
                      </div>
                    )}
                  </div>
                </CardHeader>
