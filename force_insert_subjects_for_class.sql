-- Script pour forcer l'insertion de matières pour la classe spécifique
...
SELECT 
  ...
  school_id
FROM classes 
WHERE id = '49632d55-95fd-4fce-879a-9817cfa1fc72';
...
-- Insérer des matières spécifiquement pour cette classe
INSERT INTO subjects (name, code, abbreviation, class_id, school_id, hours_per_week)
SELECT 
  'Mathématiques',
  'MATH',
  'MATH',
  '49632d55-95fd-4fce-879a-9817cfa1fc72',
  school_id,
  5
FROM school_info
UNION ALL
