-- Script simple pour créer la table user_profiles sans contrainte d'utilisateur
...
-- 5. Fonction pour créer automatiquement un profil utilisateur lors de l'inscription
...
BEGIN
  ...
  VALUES (
    ...
    '11111111-1111-1111-1111-111111111111'::uuid, -- École par défaut
    'admin'
  );
  RETURN NEW;
END;
...
-- 6. Trigger pour créer automatiquement un profil lors de l'inscription
