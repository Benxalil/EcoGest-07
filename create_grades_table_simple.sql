-- Script simplifié pour créer la table grades sans RLS
-- D'abord, supprimer la table si elle existe pour repartir à zéro
...
CREATE UNIQUE INDEX idx_grades_unique_no_exam 
