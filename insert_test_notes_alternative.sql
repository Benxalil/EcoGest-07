-- Script alternatif pour insérer des notes de test
-- Utilise NULL pour created_by si la colonne l'autorise
...
-- 2. Insérer des notes de test pour Diao Ndao (avec created_by NULL)
INSERT INTO grades (
    student_id,
    subject_id,
    grade_value,
...
-- 3. Insérer des notes de test pour Zeyna Aw (avec created_by NULL)
INSERT INTO grades (
    student_id,
    subject_id,
    grade_value,
